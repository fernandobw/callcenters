    ...
    return (
        <>
            ...
            {location.pathname === '/account/users' &&
                <Users theKey="users" userRole={'CONSULTOR'} />
            }

            {location.pathname === '/account/clients' &&
                <Clients userRole={'CONSULTOR'} />
            }

            {location.pathname === '/account/localities' &&
                <Localities userRole={'CONSULTOR'} />
            }

            {location.pathname === '/account/vacancies' &&
                <Vacancies userRole={'CONSULTOR'} />
            }

            {location.pathname === '/account/requests' &&
                <Requests userRole={'CONSULTOR'} />
            }
        </>
    );
}
 
export default ConsultorRol;